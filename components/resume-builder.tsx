...
function generateSampleResume(personalInfo: PersonalInfo, jobDescription: string): string {
...
function generateSampleCoverLetter(personalInfo: PersonalInfo, jobDescription: string): string {
  const jobKeywords = extractKeywords(jobDescription)
